...
/****************************************************************************************
 ...
 1.JKTextFieldObserver专用于珍夕端，用来监听textField输入，过滤字符，默认限制8个字符的汉字、数字、英文，适用于登补名称输入、云聊模块所有名称修改、添加提醒标题、个人名称修改
 ...
 return [self.textFieldObserver textField:textField shouldChangeString:string];
 }
...
/**    详情及用法见.h文件顶部的介绍    */
@interface JKTextFieldObserver : NSObject <UITextFieldDelegate>
